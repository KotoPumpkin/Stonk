...
class MessageType(Enum):
    ...
    ADMIN_ADD_ROBOT = "ADMIN_ADD_ROBOT"
    ADMIN_SET_ROBOT_PARAM = "ADMIN_SET_ROBOT_PARAM"
    ADMIN_PRICE_INTERVENTION = "ADMIN_PRICE_INTERVENTION"
    ADMIN_DESTROY_ROOM = "ADMIN_DESTROY_ROOM"
    ADMIN_KICK_USER = "ADMIN_KICK_USER"
    ADMIN_STOCK_INTERVENTION = "ADMIN_STOCK_INTERVENTION"
